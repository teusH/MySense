...
asdfasdfsadf"""
# comes from Adafruit
# $Id: BME280.py,v 1.3 2018/03/28 15:13:35 teus Exp teus $
...
class BME_I2C:
    ...
    def temperature(self,raw=False):
        ...
        return _calibrate(self.calibrate['temperature'],t,True if self.raw else raw)
        #ti = t // 100
        #td = t - ti * 100
        #time.sleep(2)
    ...
    def pressure(self,raw=False):
        ...
        return _calibrate(self.calibrate['pressure'],p,True if self.raw else raw)
        #pi = p // 100
        #pd = p - pi * 100
    ...
    def humidity(self,raw=False):
        ...
        return _calibrate(self.calibrate['humidity'],h,True if self.raw else raw)
        #hi = h // 1024
