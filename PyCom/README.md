...
Configuration dictionary 'power' will define to enable/disable power on 'ttl', 'i2c', 'led' (rgb led) and 'display'. As well 'sleep' to enable a soft deepsleep (without sleep pin use).
