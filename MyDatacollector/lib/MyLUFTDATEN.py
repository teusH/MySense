...
# $Id: MyLUFTDATEN.py,v 4.7 2021/09/30 13:52:51 teus Exp teus $
...
"""
__modulename__='$RCSfile: MyLUFTDATEN.py,v $'[10:-4]
...
def publish(**args):
    ...
    if reasons:
      return "Forwarding to Sensors.Community disabled: '%s'" % ','.join(reasons)
    for one in artifacts:
      if skip.match(one): return "Forwarding to Sensors.Community skipped: %s" % str(one)
