...
# $Id: MyLoRaCode.py,v 2.11 2021/10/11 14:26:50 teus Exp teus $
          ...
          while i < len(PackedData):
            ...
            try:
              if i < 0:
                ...
                sys.stderr.write("ERROR: Datagram error for %s on port %s or format %s with %s. Skip.\n" % (raw,str(port),str(format),str(e)))
                return { 'data': data, }
            fields = []
